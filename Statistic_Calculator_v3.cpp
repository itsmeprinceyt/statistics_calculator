...
class stats
{
	...
	float inex[25][2];		// for storing inexlusive data
	
	int mv;							// to store middle value	
	float af=0;						// to store adjustment factor
	...
	void inexclusive()
	{
		af=(array5[1][0]-array5[0][1])/2;
		for(i=0;i<si;i++)		// adjusting class interval
			{
				inex[i][0]=array5[i][0]-af;
				inex[i][1]=array5[i][1]+af;
			}
	}
	...
	void conti_D()
	{
		...
		while(men2==0)
			...
			if(array5[0][1]!=array5[1][0])
			{
				inexclusive();
				cout<<"\n\nC.I"<<setw(10)<<"X"<<setw(8)<<"F"<<setw(8)<<"FX"<<endl;		// showing entered data - inexclusive
				for(i=0;i<si;i++)																						
				{																										
					cout<<inex[i][0]<<" - "<<inex[i][1]<<setw(7)<<array[i]<<setw(8)<<array2[i]<<setw(8)<<array3[i]<<endl; 
				}
			}
			else
			{
	...
	void conti_S()
	{
		...
		while(men2==0)
			...
			if(array5[0][1]!=array5[1][0])
			{
				...
				for(i=0;i<si;i++)																						
				{																										
					cout<<inex[i][0]<<" - "<<inex[i][1]<<setw(7)<<array[i]<<setw(8)<<array2[i]<<setw(8)<<array3[i]<<setw(8)<<array4[i]<<endl; 
				}
			}
			else
			{
	...
	void conti_SDM()
	{
		...
		while(men2==0)
			...
			if(array5[0][1]!=array5[1][0])
			{
				...
				for(i=0;i<si;i++)																						
				{																										
					cout<<inex[i][0]<<" - "<<inex[i][1]<<setw(7)<<array[i]<<setw(8)<<array2[i]<<setw(8)<<array3[i]<<setw(8)<<array4[i]<<setw(8)<<array6[i]<<endl; 
				}	
			}
			else
			{
	...
	while(men==0)
	{
		...
		switch(choice)
		{
            ...
            case 5:
				...
				cout<<"\n\n1.2\n";
				cout<<"\n-> Now user can enter inexclusive class interval.";
                break;
            default:
                cout<<"\n\nENTER VALID OPTION!";
                break;
